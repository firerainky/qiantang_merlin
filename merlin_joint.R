...
df_cr <- bind_rows(df_fail, df_succ)
...
cif_failure <- predict(m3, stat = "cif", model = 1, time = 30, type = "marginal")
...
# 创建你想预测的时间点（单位和模型中 stime 一致，例如“天”）
times <- 1:365
